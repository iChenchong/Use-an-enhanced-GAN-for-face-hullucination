...
Flags.DEFINE_integer('num_block', 16, 'How many residual blocks are there in the generator')
...
Flags.DEFINE_float('p_ratio', 0.1, 'The ratio between content loss and perceptual loss')
